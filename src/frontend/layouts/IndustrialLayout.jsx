      ...
      <main className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <header className="h-20 md:h-24 bg-brand-ivory border-b border-mistral-black/10 px-4 md:px-8 flex justify-between items-center z-10 shadow-sm sticky top-0">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-heading font-semibold text-base md:text-2xl uppercase tracking-tight text-mistral-black truncate">
              {company ? `${company} — Industry Portal` : 'Industry Portal'}
            </h1>
          </div>
        </header>
