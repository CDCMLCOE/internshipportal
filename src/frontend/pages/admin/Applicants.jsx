...
const AdminApplicants = () => {
  ...
  const fetchApplicants = async () => {
    ...
    try {
      ...
      const formatted = (data || []).map(app => ({
        ...
        college: app.profiles?.college || 'N/A', prn: app.profiles?.prn_no || 'N/A',
        status: app.status, branch: app.profiles?.branch || 'N/A', student_id: app.student_id, profile: app.profiles
      }));
  ...
  return (
    <div className="space-y-8">
      <PageHeader title="Applicant Tracking" subtitle="Review and manage student applications for internship listings.">
