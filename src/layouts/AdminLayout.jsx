      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="bg-brand-ivory border-b border-mistral-black/10 p-4 md:p-8 flex justify-between items-center z-10 shadow-sm">
          ...
          <div className="flex items-center gap-4">
             <div className="w-10 h-10 bg-mistral-black rounded-full border border-mistral-black/20 flex items-center justify-center font-bold text-white text-sm uppercase">
               AD
             </div>
          </div>
        </header>
