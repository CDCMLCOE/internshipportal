  ...
  return (
    <div className="min-h-screen bg-brand-cream/30 flex flex-col md:flex-row font-sans text-mistral-black">
      ...
      <aside className="w-full md:w-64 bg-brand-ivory border-r border-mistral-black/10 flex flex-col">
        <div className="p-8 border-b border-mistral-black/10 flex justify-center md:justify-start">
          <Link to="/">
            <img src={logoUrl} alt="Logo" className="h-10 object-contain grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all duration-300" />
          </Link>
        </div>
