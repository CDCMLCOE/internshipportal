        ...
        >
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex justify-center mb-4">
              <img src={logoUrl} alt="MES Logo" className="h-24 md:h-32 w-auto object-contain" />
            </div>
            ...
            <motion.h2
              ...
              className="text-[20px] md:text-[24px] font-heading font-semibold text-mistral-black/70 mb-4"
            >
          ...
          <motion.h2
            ...
            className="mt-6 text-[18px] md:text-[20px] font-sans font-medium max-w-4xl mx-auto text-mistral-black leading-relaxed"
          >
