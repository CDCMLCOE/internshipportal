...
const About = () => {
  return (
    <motion.div
      ...
      className="pt-40 pb-20 px-8 max-w-5xl mx-auto"
    >
      ...
      {/* Stats or Highlights */}
      <div className="bg-mistral-black text-white p-8 md:p-12 grid grid-cols-2 md:grid-cols-4 gap-8 text-center rounded-2xl shadow-xl">
        <div>
